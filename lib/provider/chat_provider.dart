...
import 'package:pcgo/data/model/body/MessageBody.dart';
import 'package:pcgo/data/model/response/base/api_response.dart';
import 'package:pcgo/data/model/response/chat_info_model.dart';
import 'package:pcgo/data/model/response/chat_model.dart';
import 'package:pcgo/data/repository/chat_repo.dart';
import 'package:pcgo/helper/api_checker.dart';
import 'package:pcgo/helper/date_converter.dart';
  ...
  void filterList(String query) {
    ...
    if(query.isNotEmpty) {
      _uniqueShopAllList.forEach((uniqueShop) {
        if ((uniqueShop.shop.name).toLowerCase().contains(query.toLowerCase())) {
          _uniqueShopList.add(uniqueShop);
        }
      });
    }else {
