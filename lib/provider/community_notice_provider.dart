...
import 'package:yeka/data/repository/community_notice_repo.dart';

import 'package:yeka/data/model/response/base/api_response.dart';
import 'package:yeka/helper/api_checker.dart';

class CommunityNoticeProvider extends ChangeNotifier {
  final CommunityNoticeRepo communityRepo;

  CommunityNoticeProvider({@required this.communityRepo});
