...
if(this.community_type!=null) data['community_type'] = this.community_type;
if(this.community_title!=null) data['community_title'] = this.community_title;
if(this.community_content!=null) data['community_content'] = this.community_content;
if(this.community_link!=null) data['community_link'] = this.community_link;
if(this.views!=null) data['views'] = this.views;
if(this.writer!=null) data['writer'] = this.writer;
