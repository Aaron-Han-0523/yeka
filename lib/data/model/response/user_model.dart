...
if(this.business_registration_number!=null) data['business_registration_number'] = this.business_registration_number;
if(this.business_registration_file!=null) data['business_registration_file'] = this.business_registration_file;
...
if(this.withdrawal_request_flag!=null) data['withdrawal_request_flag'] = this.withdrawal_request_flag;
if(this.withdrawal_request_amount!=null) data['withdrawal_request_amount'] = this.withdrawal_request_amount;
