...
// import 'package:yeka/provider/facebook_login_provider.dart';
// import 'package:yeka/provider/google_sign_in_provider.dart';
              ...
              InkWell(
                ...
                child: Ink(color: Color(0xFF397AF3),
                  child: Padding(padding: EdgeInsets.all(6),
                    child: Card(child: Padding(padding: const EdgeInsets.all(8.0),
                        child: Wrap(crossAxisAlignment: WrapCrossAlignment.center,
                          children: [Container(height: 30,width: 30,
