...
class MyPageMyReserveScreen extends StatefulWidget {
  ...
  @override
  State<MyPageMyReserveScreen> createState() => _MyPageMyReserveScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Consumer<CustomImageProvider>(
      builder: (context, imageProvider, child) {
        ...
        String consultantImage = imageList[0].path;
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: FadeInImage.assetNetwork(
                                ...
                                fit: BoxFit.cover,
                                width:
                                    MediaQuery.of(context).size.width * 0.89333,
                                height:
                                    MediaQuery.of(context).size.width * 0.89333,
                            ...
                            TableRow(
                              children: [
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    for (var text in (userModel != null &&
                                                userModel.resume != null
                                            ? userModel.resume
                                            : "")
                                        .split("\\n"))
                                      Text(
