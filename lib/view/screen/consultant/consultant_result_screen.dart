...
class _ConsultantResultScreenState extends State<ConsultantResultScreen>
  ...
  Widget buildSlider(String leftString, String rightString,
      SfRangeValues currentSliderValue) {
    return Padding(
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    ...
    personalColorModel =
    await Provider
        .of<PersonalColorProvider>(context, listen: false)
        .personalColor;

    imageModel = Provider
        .of<CustomImageProvider>(context, listen: false)
        .image;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (personalColorModel != null) {
      ...
      if (personalColorModel.matching_color_array != null &&
          personalColorModel.matching_color_array
              .split(",")
              .length > 11) {
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "${getTranslated(
                                      'CERTIFICATE_CONSULTANT', context)}",
                                  style: TextStyle(
                  ...
                  Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "${personalColorModel != null ? personalColorModel
                              .makeup_base : ""}",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: Color(0xff333333),
