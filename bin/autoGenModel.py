...
for ref_file in file_list:
    ...
    f2.write("    }\n")
    f2.write("  }\n")
    f2.write("  "+ref_camel_upper+"List.fromList(List<dynamic> iter) {\n")
    f2.write("    _count = iter.length;\n")
    f2.write("    if (iter != null) {\n")
    f2.write("      _"+ref_camel_lower+"List = [];\n")
    f2.write("      iter.forEach((v) {\n")
    f2.write("        _"+ref_camel_lower+"List.add(new "+ref_camel_upper+"Model.fromJson(Map<String, dynamic>.from(v)));\n")
    f2.write("     });\n")
    f2.write("    }\n")
    f2.write("  }\n")
    f2.write("  Map<String, dynamic> toJson() {\n")
