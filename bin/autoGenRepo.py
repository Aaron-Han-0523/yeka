...
for res_file in file_list:
    ...
    data = f.read()
    f2.write(data.replace(ref_camel_lower, res_camel_lower).replace(ref_camel_upper, res_camel_upper).replace(res_camel_lower + "_model.dart", res_snake + "_model.dart"))
